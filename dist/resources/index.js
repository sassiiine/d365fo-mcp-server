...
const WORKSPACE_RESOURCES = [
    {
        ...
        description: 'Curated snapshot of the current work: active model/project, recently ' +
    ...
    },
    {
        ...
        name: 'Active Object',
        description: 'The object the developer is most likely working on (most recently ' +
            ...
            switch (uri) {
                ...
                case 'workspace://files':
                    return json(uri, {
                        ...
                        note: snapshot.recentObjects.length === 0
