...
export function registerCodeReviewPrompt(server, context) {
...
`,
        ...
        if (promptName === 'xpp_security_guide') {
            const featureName = request.params.arguments?.featureName || '';
            return {
                messages: [
                    {
                        role: 'user',
...
`,
        ...
        if (promptName === 'xpp_sysoperation_guide') {
            const operationDescription = request.params.arguments?.operationDescription || '';
            return {
                messages: [
                    {
                        role: 'user',
...
`,
        ...
        if (promptName === 'xpp_data_entity_guide') {
            const entityCategory = request.params.arguments?.entityCategory || '';
            return {
                messages: [
                    {
                        role: 'user',
