...
export function writeBlobDownloadMarker(metadataDir, marker) {
 ...
 */
export function readBlobDownloadMarker(metadataDir) {
    try {
        const parsed = JSON.parse(fs.readFileSync(markerPath(metadataDir), 'utf-8'));
        if (typeof parsed.downloadedAt !== 'string')
            return undefined;
        return {
...
//# sourceMappingURL=blobDownloadMarker.js.map