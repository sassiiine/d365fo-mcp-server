 ...
 */
import { findFuzzyMatches, isProbableTypo, generateBroaderSearches, generateNarrowerSearches, extractRootTerm } from './fuzzyMatching.js';
/**
 * Generate suggestions for a failed search query
 */
export function generateSearchSuggestions(query, allSymbolNames, symbolsByTerm, maxSuggestions = 5) {
    const suggestions = [];
 ...
 */
function generateTypoSuggestions(query, allSymbolNames) {
    const suggestions = [];
 ...
 */
function generateBroaderSuggestions(query) {
    const suggestions = [];
 ...
 */
function generateNarrowerSuggestions(query) {
    const suggestions = [];
 ...
 */
function generateRelatedSuggestions(query, symbolsByTerm) {
    const suggestions = [];
