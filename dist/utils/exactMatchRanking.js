...
export function exactMatchRank(query, name) {
    if (name === query)
        return 0;
...
export function isExactNameMatch(query, name) {
 ...
 * name equality).
 */
export function rankExactFirst(query, items, nameOf) {
    return items
 ...
 */
export function rankCustomFirst(query, items, nameOf, isCustom) {
    return items
        .map((item, idx) => {
...
//# sourceMappingURL=exactMatchRanking.js.map