 ...
 */
export function clearAutoDetectedModels() {
 ...
 */
export function getExtensionPrefix() {
 ...
 */
export function getObjectSuffix() {
 ...
 */
export function getExtensionNamingStyle() {
 ...
 */
export function applyObjectSuffix(objectName, suffix) {
    if (!suffix)
        return objectName;
 ...
 */
export function resolveObjectPrefix(modelName) {
 ...
 */
export function deriveExtensionInfix(resolvedPrefix, modelName) {
    if (!resolvedPrefix)
        return '';
    const learned = modelName ? getInferredModelPrefix(modelName) : null;
    if (learned?.infix)
        return learned.infix;
 ...
 */
export function resolveRegularObjectPrefixToken(modelName) {
 ...
 */
export function applyObjectPrefix(objectName, prefix, modelName) {
    if (!prefix)
        return objectName;
 ...
 */
export function isCustomModel(modelName) {
 ...
 */
export function isStandardModel(modelName) {
    return !isCustomModel(modelName);
}
//# sourceMappingURL=modelClassifier.js.map