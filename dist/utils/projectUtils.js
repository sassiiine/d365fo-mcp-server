 ...
 */
export function extractModelFromProject(projectPath) {
 ...
 */
export function findProjectInSolution(solutionPath) {
    // Windows paths (K:\...) are not accessible on non-Windows — skip silently
    ...
    try {
        const files = fs.readdirSync(solutionPath, { recursive: true });
