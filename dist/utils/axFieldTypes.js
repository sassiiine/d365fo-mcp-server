 ...
 */
export const AX_FIELD_BASE_TYPES = [
 ...
 */
export function normalizeFieldBaseType(raw) {
 ...
 */
export function baseTypeFromEdtName(edtName) {
    if (!edtName)
        return undefined;
