...
export function resetMetadataMtimeCache() {
    scanCache.clear();
}
/**
 ...
 */
export function findNewestMetadataMtime(rootDir) {
    ...
    const walk = (dir) => {
        ...
        for (const entry of entries) {
            ...
            if (entry.isDirectory()) {
                ...
                if (lower === 'bin' || lower === '.git' || lower === 'xppmetadata')
                    continue;
                walk(full);
            }
 ...
 */
export function checkIndexStaleness(lastIndexedAt, modelMetadataDir) {
