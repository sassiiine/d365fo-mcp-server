 ...
 */
export function stripGeneratedAt(md) {
 ...
 */
export function withBadge(readme, report) {
    const colour = report.core.percent >= 90 ? 'brightgreen' : report.core.percent >= 70 ? 'yellow' : 'orange';
    const badge = `[![Core coverage](https://img.shields.io/badge/core_coverage-${report.core.percent}%25-${colour}.svg)](eval/COVERAGE.md) ` +
...
//# sourceMappingURL=artifactCompare.js.map