 ...
 */
import { canonicalizePrefix, PREFIX_PLACEHOLDER } from './prefix.js';
 ...
 */
export function artifactKey(filename, prefix = '') {
    ...
    if (stem.startsWith(PREFIX_PLACEHOLDER))
        stem = stem.slice(PREFIX_PLACEHOLDER.length);
 ...
 * `filename → key` map.
 */
export function artifactKeyMap(names, prefix = '') {
...
//# sourceMappingURL=artifactKey.js.map