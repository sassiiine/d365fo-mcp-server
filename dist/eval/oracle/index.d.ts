...
import { type BuildResult, type Score } from './score.js';
import { type SysTestResult } from './systest.js';
export { normalizeAotXml, normalizeMultiArtifact, renderNormalized, globToRegExp, GOLDEN_CAPTURE_PREFIX, GOLDEN_CAPTURE_PREFIXES, canonicalizePrefix, type PrefixSpec, } from './normalize.js';
...
export declare function evaluate(input: EvaluateInput): Promise<EvaluateResult>;
 ...
 */
export declare function evaluateMulti(input: EvaluateMultiInput): Promise<EvaluateResult>;
