 ...
 */
export function resolveActualFile(actualDir, goldenName, goldenPrefix, actualPrefix) {
 ...
 * paths as `missing`.
 */
export function buildActualArtifactsMap(actualDir, artifactNames, goldenPrefix, actualPrefix) {
    const actualArtifacts = {};
    const matchedActualFiles = new Set();
...
//# sourceMappingURL=actualArtifactResolution.js.map