...
export function modelErrorClusters(runs) {
 ...
 */
export function scoreTopicMatch(symptom, entry) {
...
export function suggestKnowledgeTopic(symptom, knowledgeBase) {
    let best = null;
...
export function buildKnowledgeProposals(runs, knowledgeBase) {
...
export function renderKnowledgeProposals(proposals) {
    if (proposals.length === 0)
        return 'No MODEL_ERROR clusters — nothing to propose. 🎉';
    const lines = [`# Knowledge-base feedback proposals (${proposals.length})\n`];
...
//# sourceMappingURL=knowledgeFeedback.js.map