...
import { mineCaseFromFailure, writeMinedCase } from './caseMining.js';
...
function main() {
    ...
    if (!title || !tier || !instruction || !types) {
        console.error('usage: tsx src/eval/improver/caseMiningCli.ts --title "..." --tier N --instruction "..." ' +
...
main();
//# sourceMappingURL=caseMiningCli.js.map