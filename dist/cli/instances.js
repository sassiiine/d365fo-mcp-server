...
export function listInstances() {
    if (!fs.existsSync(paths.instancesDir))
        return [];
 ...
 */
export function isLegacyInstanceLayout(inst) {
 ...
 */
export function normalizeInstanceLayout(inst) {
...
export function suggestPort(instances) {
    const used = instances.map(i => i.port).filter((p) => p !== null);
 ...
 */
export function createInstance(name, port) {
