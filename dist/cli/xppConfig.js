...
export function listXppConfigs() {
...
function pinnedConfigName(store) {
 ...
 */
export function isXppConfigStale(store) {
    if (readSetting(store, envTypeSetting) === 'traditional')
        return false;
...
//# sourceMappingURL=xppConfig.js.map