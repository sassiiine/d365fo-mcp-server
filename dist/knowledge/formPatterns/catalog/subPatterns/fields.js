...
export const fieldsFieldGroups = {
...
export const horizontalFieldsButtonGroup = {
...
export const fieldsSubPatterns = [
    fieldsFieldGroups,
    tabularFields,
    fillText,
...
export const businessCardThreeFields = {
...
export const businessCardIndicator = {
...
export const tabPageTabularFields = {
...
export const allFieldsSubPatterns = [
    ...fieldsSubPatterns,
    customSubPattern,
