...
export const nestedSimpleListDetails = {
...
export const toolbarAndListDouble = {
...
export const dimensionEntryControl = {
...
export const dimensionExpressionBuilder = {
...
export const toolbarSubPatterns = [
    toolbarAndList,
