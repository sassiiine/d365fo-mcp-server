...
export const workspacePanorama = {
    id: 'Workspace',
...
export const formPartSectionList = {
...
export const formPartSectionListDouble = {
    ...
    versions: ['1.2', '1.1', '1.0'],
    purpose: 'A workspace section list with two lists — the primary visible list and a secondary hidden ' +
...
export const workspaceOperational = {
