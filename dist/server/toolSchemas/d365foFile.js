    ...
    inputSchema: {
        ...
        properties: {
            ...
            properties: {
                ...
                description: '[create] Per-objectType creation properties (label, fields[], extends, enumValues[], primaryTable, …) — ' +
            ...
            operations: {
                type: 'array',
                maxItems: 20,
                description: '[modify] PREFERRED for 2+ edits to the SAME object — ONE call, not one per edit. ' +
            ...
            params: {
                type: 'object',
                additionalProperties: true,
                description: '[modify] Operation-specific parameters as ONE nested object, per get_knowledge(kind="op-spec", ' +
