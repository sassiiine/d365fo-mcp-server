...
export const searchTool = {
    name: 'search',
    description: 'Search pre-indexed D365FO objects by name or keyword. Three modes in ONE tool:\n' +
    ...
    inputSchema: {
        ...
        properties: {
            ...
            globalTypeFilter: {
                type: 'array',
                maxItems: 5,
                description: '[batch] Default type filter for queries without an explicit per-query type. ' +
            ...
            deduplicate: {
                type: 'boolean',
                default: true,
                description: '[batch] When true, symbols appearing in multiple query results are collapsed. ' +
                    'Later occurrences are replaced with a reference to the query where they first appeared.',
            },
            crossReference: {
                type: 'boolean',
                default: true,
                description: '[batch] Append a cross-reference summary at the end listing symbols that appeared in multiple queries. ' +
