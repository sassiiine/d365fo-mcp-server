...
export const createModelTool = {
    ...
    description: 'Create a new D365FO model: descriptor, AOT folders, .rnrproj and the PackagesLocalDirectory link. ' +
    ...
    inputSchema: {
        ...
        properties: {
            ...
            repoRoot: {
                type: 'string',
                description: 'Metadata repo root (contains Metadata\\ and Projects\\). Given: created there and junctioned in, so it ' +
