...
export declare function isBridgeFailure(value: unknown): value is BridgeFailure;
/** Marker the dispatcher looks for so a tool that already reported the failure isn't annotated twice. */
export declare const BRIDGE_FAILURE_MARKER = "bridge errored:";
/**
 ...
 */
export declare function runWithBridgeFailureScope<T>(sink: BridgeFailure[], fn: () => Promise<T>): Promise<T>;
/**
 ...
 */
export declare function recordBridgeFailure(operation: string, error: unknown, options?: {
    quiet?: boolean;
}): BridgeFailure;
/** One-line description of a failure, for a tool that wants to name it in its own message. */
export declare function describeBridgeFailure(failure: BridgeFailure): string;
/**
 ...
 */
export declare function renderBridgeFailureNote(failures: BridgeFailure[]): string;
//# sourceMappingURL=bridgeFailure.d.ts.map