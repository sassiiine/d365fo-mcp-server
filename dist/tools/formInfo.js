...
export async function getFormInfoTool(request, context) {
    try {
        ...
        const { formName, filePath: explicitFilePath, includeControls, includeDataSources, includeMethods, searchControl, } = args;
 ...
 */
async function parseAndFormatForm(formName, modelName, xmlContent, includeControls, includeDataSources, includeMethods, searchControl) {
 ...
 * Format form output
 */
function formatFormOutput(formInfo, includeControls, includeDataSources, includeMethods) {
 ...
 */
function formatControlHierarchy(controls, indent) {
    let output = '';
