...
const GetObjectInfoArgsSchema = z.object({
    objectType: z.enum(OBJECT_INFO_TYPES).describe('Kind of object to read: class, table, form, query, view, enum, edt, report, ' +
    ...
    options: z.record(z.string(), z.any()).optional().describe('Optional type-specific flags forwarded to the reader. ' +
...
export async function getObjectInfoTool(request, context) {
    ...
    if (methodOffset !== undefined)
        options.methodOffset = methodOffset;
