 ...
 */
import { runRules } from '../analysis/validateXpp.js';
 ...
 */
export function extractDeclaration(xml) {
...
function render(violations) {
    ...
    if (errors.length > 0) {
        lines.push('➡️  Fix these with d365fo_file(action="modify") BEFORE build_d365fo_project — ' +
...
//# sourceMappingURL=inlineXppValidation.js.map