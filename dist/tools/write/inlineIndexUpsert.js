 ...
 * for no benefit.
 */
export async function upsertWrittenFileIntoIndex(filePath, context) {
    if (!filePath || !context?.symbolIndex)
        return '';
    try {
        const result = await indexOneFile(filePath, context);
        if (result.isError) {
...
//# sourceMappingURL=inlineIndexUpsert.js.map