...
export const runBpCheckTool = async (params, _context) => {
    ...
    try {
        ...
        const buildArgsColonStyle = (metadataFlag, compilerMetadataFlag) => {
            const a = [
        ...
        let stdout = '';
        let stderr = '';
        const { combined, lastStdout, lastStderr } = await withOperationLock(`bp:${modelName}`, async () => {
