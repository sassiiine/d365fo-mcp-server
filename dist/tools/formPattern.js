...
export const FORM_PATTERN_ACTIONS = ['analyze', 'validate', 'spec', 'repair'];
const FormPatternArgsSchema = z
    .object({
    action: z.enum(FORM_PATTERN_ACTIONS).describe('analyze (recommend/inspect form patterns), validate (check AxForm XML structure), ' +
...
export async function formPatternTool(request, context) {
...
//# sourceMappingURL=formPattern.js.map