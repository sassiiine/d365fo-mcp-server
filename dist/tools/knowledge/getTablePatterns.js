...
export async function handleGetTablePatterns(args, symbolIndex) {
...
export async function getTablePatternsTool(request, context) {
    try {
...
async function analyzeSimilarTable(symbolIndex, requestedName, limit) {
...
async function analyzeTableGroup(symbolIndex, tableGroup, limit) {
    const rdb = symbolIndex.getReadDb();
    let output = '';
...
//# sourceMappingURL=getTablePatterns.js.map