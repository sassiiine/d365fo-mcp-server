...
export const METHOD_INCLUDES = ['signature', 'source', 'both'];
...
export async function getMethodTool(request, context) {
    ...
    if (!rest.className) {
        return {
            content: [{
                    type: 'text',
                    text: `❌ get_method: missing required parameter "className".\n\n` +
