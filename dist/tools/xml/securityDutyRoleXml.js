 ...
 */
export function normalizeNameList(value) {
    if (!value)
        return [];
 ...
 */
export function securityRefContainer(container, childTag, names) {
    if (names.length === 0)
        return `\t<${container} />`;
 ...
 */
export function buildAxSecurityDutyXml(name, properties) {
 ...
 */
export function buildAxSecurityRoleXml(name, properties) {
    const label = properties?.label || '@TODO:LabelId';
 ...
 */
export function buildAxSecurityDutyExtensionXml(name, properties) {
    const privileges = normalizeNameList(properties?.privileges);
    return `<?xml version="1.0" encoding="utf-8"?>
 ...
 */
export function buildAxSecurityRoleExtensionXml(name, properties) {
    const duties = normalizeNameList(properties?.duties);
    const privileges = normalizeNameList(properties?.privileges);
    return `<?xml version="1.0" encoding="utf-8"?>
...
//# sourceMappingURL=securityDutyRoleXml.js.map