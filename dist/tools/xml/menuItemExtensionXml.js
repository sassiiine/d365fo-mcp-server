 ...
 */
const NAMED_PROPERTY_MODIFICATIONS = [
    ['object', 'Object'],
    ['label', 'Label'],
    ['helpText', 'HelpText'],
 ...
 *   property.
 */
export function buildAxMenuItemExtensionXml(rootElement, name, properties) {
    const mods = [];
    const push = (modName, value) => {
        if (value === undefined || value === null || value === '')
            return;
        if (mods.some(m => m.name.toLowerCase() === modName.toLowerCase()))
            return;
...
//# sourceMappingURL=menuItemExtensionXml.js.map