 ...
 */
export declare function normalizeNameList(value: any): string[];
/**
 ...
 */
export declare function securityRefContainer(container: string, childTag: string, names: string[]): string;
/**
 * AxSecurityDuty.
 * properties.privileges – privilege names to reference (array or comma-separated).
 */
export declare function buildAxSecurityDutyXml(name: string, properties?: Record<string, any>): string;
/**
 * AxSecurityRole.
 ...
 */
export declare function buildAxSecurityRoleXml(name: string, properties?: Record<string, any>): string;
/**
 ...
 */
export declare function buildAxSecurityDutyExtensionXml(name: string, properties?: Record<string, any>): string;
/**
 ...
 */
export declare function buildAxSecurityRoleExtensionXml(name: string, properties?: Record<string, any>): string;
//# sourceMappingURL=securityDutyRoleXml.d.ts.map