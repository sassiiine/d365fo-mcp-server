...
export async function objectPatternsTool(request, context) {
    ...
    if (domain === 'form') {
        ...
        if (!action) {
            if (pattern !== undefined)
                action = 'spec';
            else if (a.xml !== undefined || a.formName !== undefined || a.filePath !== undefined)
                action = 'validate';
            else
                action = 'analyze';
        }
    ...
    return err(`object_patterns: could not determine domain (got domain/objectType="${got}"). ` +
...
//# sourceMappingURL=objectPatterns.js.map