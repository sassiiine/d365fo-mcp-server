 ...
 * live instance.
 */
export declare class SqliteSearchAdapter implements ISearchIndex {
    private readonly getIndex;
    constructor(getIndex: () => XppSymbolIndex);
    searchSymbols(query: string, limit?: number, types?: string[]): Promise<XppSymbol[]>;
    searchByPrefix(prefix: string, types?: string[], limit?: number): Promise<XppSymbol[]>;
    getSymbolByName(name: string, type: string): Promise<XppSymbol | null>;
    searchLabels(query: string, opts?: LabelSearchOpts): Promise<LabelRow[]>;
 ...
 */
export declare function makeSearchBackend(getIndex: () => XppSymbolIndex): ISearchIndex;
/**
 ...
 */
export declare function searchBackend(context: {
    symbolIndex: XppSymbolIndex;
    searchIndex?: ISearchIndex;
}): ISearchIndex;
//# sourceMappingURL=searchBackend.d.ts.map