...
export interface XppSymbol {
    name: string;
    type: 'class' | 'table' | 'form' | 'query' | 'view' | 'method' | 'field' | 'enum' | 'edt' | 'report' | 'security-privilege' | 'security-duty' | 'security-role' | 'menu-item-display' | 'menu-item-action' | 'menu-item-output' | 'table-extension' | 'class-extension' | 'form-extension' | 'enum-extension' | 'edt-extension' | 'data-entity-extension' | 'view-extension' | 'query-extension' | 'map-extension' | 'menu-extension' | 'security-duty-extension' | 'security-role-extension' | 'menu-item-display-extension' | 'menu-item-action-extension' | 'menu-item-output-extension' | 'menu' | 'service' | 'service-group' | 'map' | 'configuration-key' | 'license-code' | 'security-policy' | 'macro';
    parentName?: string;
    signature?: string;
    filePath: string;
    model: string;
